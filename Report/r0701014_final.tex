...
Now that the operators are chosen, different experiments can be performed on the parameters of the evolutionary algorithm. If a value of a parameter was suggested by the authors of a paper about the operator, then this value was used and not changed or included in the hyperparamter search.
